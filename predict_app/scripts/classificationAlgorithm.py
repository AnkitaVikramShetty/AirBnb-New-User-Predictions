...
def predict_app_prediction(fileName):
    ...
    dataframe.to_csv(preProcessedFileName, columns=["gender", "age", "signup_method", "signup_flow", "language", "affiliate_channel", "affiliate_provider", "first_affiliate_tracked", "signup_app", "first_device_type", "first_browser", "dac_year", "dac_month", "dac_day", "tfa_year", "tfa_month", "tfa_day"]);
