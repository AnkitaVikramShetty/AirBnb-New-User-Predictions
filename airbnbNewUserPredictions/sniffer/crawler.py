...
from airbnbNewUserPredictions.core.models import Product, Image
from airbnbNewUserPredictions.sniffer.models import CrawlFrontier


class AirbnbNewUserPredictions(object):
    
    def __init__(self):
        self.headers = { 'user-agent': 'airbnbNewUserPredictions/1.0' }
